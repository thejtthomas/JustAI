...
def display_content(selected_option):
    ...
    elif selected_option == "Client" or selected_option == "Lawyer":
        sign_up()
        login()
...
display_content(selected_sidebar)
 

# 2. Horizontal menu
st.title("Just AI")
st.subheader("Your Pocket Legal Advisor")
...
display_content(selected_horizontal)
